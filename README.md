...
<dependency>
    ...
    <version>0.1.10</version>  <!-- This version is automatically updated -->
</dependency>
```
...
dependencies {
    implementation 'com.bsdevelopment.pluginutils:BSPluginUtils:0.1.10' // This version is automatically updated
}
```
...
2. This README file is updated automatically – all occurrences of version numbers (for example, "0.1.10") are replaced with the published version.
