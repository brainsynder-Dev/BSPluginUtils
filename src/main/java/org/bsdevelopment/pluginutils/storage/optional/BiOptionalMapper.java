 ...
 *
 * @param <T>
 *         the type of the first value in the associated {@link BiOptional}
 * @param <U>
 *         the type of the second value in the associated {@link BiOptional}
 * @param <R>
 *         the type of the result produced by this mapper
 */
public class BiOptionalMapper<T, U, R> {
     ...
     *
     * @param firstMapper
     *         a function mapping the first value to a result
     *
     ...
     *
     * @param secondMapper
     *         a function mapping the second value to a result
     *
     * @return this mapper, for chaining
     */
     ...
     *
     * @param bothMapper
     *         a function that takes both values and produces a result
     *
     * @return this mapper, for chaining
     */
     ...
     *
     * @param supplier
     *         a supplier that provides the result if none are present
     *
     * @return this mapper, for chaining
     */
     ...
     *
     * @param other
     *         the result object when none are present
     *
     * @return this mapper, for chaining
     */
     ...
     *         a supplier of the exception to be thrown
     * @param <X>
